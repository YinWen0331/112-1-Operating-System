...
const int SystemTick =	  10; 	// advance each time interrupts are enabled //12-10 10->1
...
const int ConsoleTime =	 1;	// time to read or write one character    //12-7 100->1
const int NetworkTime =	 100;  	// time to send or receive one packet
const int TimerTicks = 	 100;  	// (average) time between timer interrupts    //12-7 100->1
